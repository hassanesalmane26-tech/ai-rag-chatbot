...
import ModuleErrorBoundary from "../../../app/modules/ModuleErrorBoundary";
...
export default function WorkspaceRouter() {
  ...
  const moduleKey = `${activeWorkspace.id}:${activeView}`;
  return <ModuleErrorBoundary key={moduleKey}><Suspense fallback={<section className="empty-state" aria-live="polite"><h2>Ouverture du module</h2><p>Préparation du Workspace…</p></section>}><ModuleView key={moduleKey} workspaceId={activeWorkspace.id} /></Suspense></ModuleErrorBoundary>;
}
