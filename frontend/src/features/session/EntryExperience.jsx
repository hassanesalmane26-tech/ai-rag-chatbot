...
export default function EntryExperience() {
  ...
  return <main className="entry-experience">
    ...
    <section className="entry-panel ds-glass-panel ds-glass-panel--elevated">
      ...
      {state === "authenticated" && organizations.length === 0 && <><h1>Identité vérifiée</h1><p>Aucune Organization ne vous a encore accordé l’accès à un Workspace.</p><button className="ds-button ds-button--secondary" type="button" onClick={() => logout().catch(() => {})}>Se déconnecter</button></>}
