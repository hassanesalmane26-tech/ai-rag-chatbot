...
export default function MemoryView() {
  ...
  const { memories, loading, mutationId, error, lifecycle, refresh, create, update, toggle, remove } = useWorkspaceMemories(activeWorkspaceId);
  ...
  return <section className="memory-view" aria-labelledby="memory-title" data-memory-state={lifecycle} aria-busy={loading || Boolean(mutationId)}>
