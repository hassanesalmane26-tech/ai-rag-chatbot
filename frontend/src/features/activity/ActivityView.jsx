...
export default function ActivityView() {
  ...
  return <section className="product-view activity-view" aria-labelledby="activity-title">
    <header className="product-view__header"><div><span>WORKSPACE ACTIVITY</span><h2 id="activity-title">Activity</h2><p>Les changements utiles et récents de {activeWorkspace?.name}.</p></div><button type="button" className="view-refresh" onClick={refresh} aria-label="Actualiser Activity"><RefreshCw size={17} /></button></header>
