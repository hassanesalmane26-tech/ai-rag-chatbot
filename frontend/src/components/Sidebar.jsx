...
export default function Sidebar() {
  ...
  return <aside className="sidebar" aria-label="Navigation du Workspace">
    ...
    <div className="sidebar-footer"><div className="status-dot"></div><div><strong>TRIDENT AI</strong><p>Created by Salmane Hassan</p><small>A TRIDENT Project</small></div></div>
  </aside>;
}
