...
export default function MobileWorkspaceSelector({ open, onClose }) {
  const { activeView, activeWorkspace, activeWorkspaceId, setActiveView, requestNovaConversation, openNovaConversation } = useWorkspaceContext();
